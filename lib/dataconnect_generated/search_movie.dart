...
class Optional<T> {
  ...
  final dynamic Function(T?) toJsonFunc;
  Optional.optional(this.fromJson, this.toJsonFunc);
  dynamic toOptionalJson() => value == null ? null : toJsonFunc(value);
  @override
  bool operator ==(Object other) => other is Optional<T> && value == other.value && state == other.state;
  @override
  int get hashCode => Object.hashAll([value, state]);
}
...
class SearchMovieVariablesBuilder {
  ...
  SearchMovieVariablesBuilder titleInput(String? t) {
    _titleInput.value = t;
    _titleInput.state = OptionalState.set;
    return this;
  }
  SearchMovieVariablesBuilder genre(String? t) {
    _genre.value = t;
    _genre.state = OptionalState.set;
    return this;
  }
...
class SearchMovieVariables {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (titleInput.state == OptionalState.set) {
      json['titleInput'] = titleInput.toOptionalJson();
    }
    if (genre.state == OptionalState.set) {
      json['genre'] = genre.toOptionalJson();
    }
    return json;
  }
